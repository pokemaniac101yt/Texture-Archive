...
public class ModItems {
    ...
    public static final Item TORCH_INDEV_0_31_20091223_1457_ITEM = Registry.register(Registries.ITEM,
            Identifier.of("texturemod", "torch_indev_0_31_20091223_1457"),
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, Identifier.of(TextureMod.MOD_ID, name), item);
    }
